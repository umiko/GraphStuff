...
import com.graphstuff.model.AdjacencyList;
...
public class AdjacencyListTest {
    ...
    void getRawAdjacencyList(){
        for(int i =0; i< al.getRawAdjacencyList().size(); i++)
            assertArrayEquals(al.getRawAdjacencyList().get(i), al.getAdjacencyListByVertex(i+1));
    }
}
